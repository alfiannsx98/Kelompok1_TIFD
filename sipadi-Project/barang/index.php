    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Data Barang <a class="btn btn-primary" href="tambah.php"><i class="fas fa-user-plus"></i></a> <a href="cetak.php" target="_blank" class="btn btn-warning"><i class="fas fa-print"></i></a> <a href="pengadaan.php" class="btn btn-dark"><i class="fas fa-cubes"></i></a></h1>
            </div>
            <!-- Content Row -->

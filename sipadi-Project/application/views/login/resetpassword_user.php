...
if (isset($_POST["simpan"])) {
    $password_admin = mysqli_real_escape_string($koneksi, $_POST["password_user"]);
    $password_admin1 = mysqli_real_escape_string($koneksi, $_POST["password_user1"]);
                            ...
                            <form action="" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user" id="password_admin" name="password_user" placeholder="Masukkan password anda" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user" id="password_admin1" name="password_user1" placeholder="masukkan password anda yang kedua" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">

    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Data Kurir <a class="btn btn-primary" href="tambah.php"><i class="fas fa-user-plus"></i></a> <a href="#" class="btn btn-warning"><i class="fas fa-print"></i></a></h1>
                </h1>
            </div>
            <!-- Content Row -->
                    ...
                    <?php foreach ($dtKur as $kur) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="hapus.php?id=<?= $kur['id_kurir']; ?>"><i class="fas fa-trash-alt"></i></a>
